...
I have just taught the SGD algorithm with backpropagation to my NLP masters students and, as every year, I found that no explanation of it on the web looks satisfying to me. As the saying goes “*on est jamais mieux servi⋅e que par soi-même*”, so I figured I'd better get one. In the worst case, it'll be useful for a future version of me (hi mate!).
